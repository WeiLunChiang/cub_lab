...
# query = "我想了解一下昨天內，飯店/住宿的詳細開銷情況。"
# query = "我想了解一下去年同期內，郵購/直銷的詳細開銷情況。"
# query = "我於這個月時，針對其他類_NOTFOUND的需求投入了多少金錢?"
query = "請告訴我，在今年第四季度我在'電子化繳費'的開銷是多少?"
query = "描述一下去年同期我在悠遊加值消費的數目"
query = "請告訴我在今年第四季度期間，我在旅遊方面的總花費是多少?"
chain.invoke(query)


# %%

csv_file = "test/test_data2.csv"
